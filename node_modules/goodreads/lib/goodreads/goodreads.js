...
(function () {
    ...
    Goodreads = (function () {
        ...
        Goodreads.prototype.getReviewsByTitle = function (title, author, id, callback) {

            this.options.path = "https://www.goodreads.com/book/title.xml?key=" + this.options.key + "&title=" + encodeURI(title) + "&author=" + encodeURI(author);
            return this.getRequest(callback, id);
        };
        ...
        Goodreads.prototype.getRequest = function (callback, id) {
            var inputID = id || null
            //console.log(inputID)
